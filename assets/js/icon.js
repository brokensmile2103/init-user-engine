const IUE_Icons = {
    ...
    gift: `<svg width="20" height="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485 485" xml:space="preserve"><path d="M0 69.9V415h485V70zm455 30v93.3h-35.5a46.3 46.3 0 0 0-74.5-50.3l-47.5 44.7-47.4-44.6-.2-.1a46.3 46.3 0 0 0-74.4 50.3H30V99.9zm-79.2 93.3-8-.2v.2h-32.4l30-28.2q4.6-4.1 10.8-4.2a16.2 16.2 0 0 1 .8 32.4zm-148.6-.2-8 .2H218a16.2 16.2 0 1 1 11.7-28.2l30 28.2h-32.4zM30 385.1v-162h222.5v67.7h30v-67.6h30v107.6h30V223.2H455v162z"></path></svg>`,
